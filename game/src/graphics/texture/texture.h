...
namespace graphics
{
    ...
    public:
        texture() : id{} {}
        texture(application& app, std::string_view file_name) : id{}
        {
            load(app, file_name);
        }
        ...
        void load(application& app, std::string_view file_name)
        {
        ...
        void load(application& app, GLenum pixel_format, const void* data, GLsizei width, GLsizei height)
        {
            this->width = width;
            this->height = height;
